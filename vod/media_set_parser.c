...
static json_object_value_def_t media_sequence_params[] = {
	...
	{ vod_string("withAccessibility"),VOD_JSON_BOOL,	offsetof(media_sequence_t, tags.with_accessibility), media_set_parse_bool },
	{ vod_string("forced"),			VOD_JSON_BOOL,		offsetof(media_sequence_t, tags.forced), media_set_parse_bool },
	...
	request_params_t* request_params)
{
	...
	for (cur_pos = part->first; ; cur_pos++, index++)
	{
		...
		cur_output->tags.with_accessibility = FALSE;
		cur_output->tags.forced = FALSE;
